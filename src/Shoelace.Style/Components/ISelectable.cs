...
public interface ISelectable
{
    ...
    /// <param name="selectMode">The selection mode. Possible values are 'select' | 'start' | 'end' | 'preserve'</param>
    /// <returns></returns>
    ...
    /// <param name="selectionDirection">The selection direction. Possible values are 'forward' | 'backward' | 'none'</param>
    /// <returns></returns>
